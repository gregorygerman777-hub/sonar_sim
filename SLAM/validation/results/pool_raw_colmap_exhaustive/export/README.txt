...
Frame: z: height above the fitted pool floor plane; x: along the floor lane stripes; origin: floor point under the centre of the camera path. x_pixel ~ K (R X + t), C = -R' t.
...
Camera height above the floor: median 0.973; median height of the model points above the floor: 0.014 (most points lie on the floor and the pebble mat).
6.6 % of the points lie above the cameras: the lane ropes at the surface and features seen in reflections in the underside of the moving water surface. The reflection points are not physical structure; they were left in rather than removed by hand.
